                        ...
                        <div id="wizard_container">
                            <form action="{{ route('reserve') }}" method="POST">
                                ...
                                <div id="middle-wizard">
                                    <div class="step">
                                        <h3 class="main_question"><strong>1/3</strong>تاریخ</h3>
                                    ...
                                    <!-- /step-->
                                    <div class="step">
                                        <h3 class="main_question"><strong>2/3</strong>زمان و تعداد نفرات</h3>
                                    ...
                                    <div class="submit step">
                                        <h3 class="main_question"><strong>3/3</strong>مشخصات
                                        </h3>
                                        <div class="form-group">
                                            <input type="text" name="name" class="form-control required"
                                                placeholder="مسعود قهرمانی">
                                        </div>
{{--                                        <div class="row">--}}
{{--                                            <div class="col-lg-6">--}}
{{--                                                <div class="form-group">--}}
...
{{--                                            </div>--}}
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <input type="text" name="phone"
                                                        class="form-control required" placeholder="09...">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" name="description"
                                                placeholder="دیگر جرئیات"></textarea>
                                        </div>
